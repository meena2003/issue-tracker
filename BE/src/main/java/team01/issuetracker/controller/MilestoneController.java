...
public class MilestoneController {
    ...
    @GetMapping
    public ResponseEntity<?> milestoneView(@RequestParam("isOpen") boolean isOpen) {
        logger.info(isOpen + "한 마일스톤 조회");
        return ResponseEntity.ok(milestoneService.getMilestone(isOpen));
    }
