...
public class AssigneeService {
    ...
    public WritersResponseDTO getWriters() {
        List<AssigneeDTO> writers = new ArrayList<>();
        writers.add(AssigneeDTO.of(new Assignee(1L, "다온"
                , "https://avatars.githubusercontent.com/u/115215178?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(2L, "포코"
                , "https://avatars.githubusercontent.com/u/101160636?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(3L, "듀이"
                , "https://avatars.githubusercontent.com/u/115435482?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(4L, "만쥬"
                , "https://avatars.githubusercontent.com/u/20828490?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(5L, "코어"
                , "https://avatars.githubusercontent.com/u/85631282?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(6L, "해나"
                , "https://avatars.githubusercontent.com/u/97685264?s=40&v=4")));
        writers.add(AssigneeDTO.of(new Assignee(7L, "하림"
                , "https://avatars.githubusercontent.com/u/90844696?s=40&v=4")));
